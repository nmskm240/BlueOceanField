...
class MarketServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetExchanges = channel.unary_unary(
                ...
                request_serializer=market__pb2.GetExchangesRequest.SerializeToString,
                response_deserializer=market__pb2.GetExchangesResponse.FromString,
                _registered_method=True)
        self.GetSymbols = channel.unary_unary(
                '/blueOceanField.market.MarketService/GetSymbols',
                request_serializer=market__pb2.GetSymbolsRequest.SerializeToString,
                response_deserializer=market__pb2.GetSymbolsResponse.FromString,
                _registered_method=True)
...
def add_MarketServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetExchanges': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=market__pb2.GetExchangesRequest.FromString,
                    response_serializer=market__pb2.GetExchangesResponse.SerializeToString,
            ),
            'GetSymbols': grpc.unary_unary_rpc_method_handler(
                    servicer.GetSymbols,
                    request_deserializer=market__pb2.GetSymbolsRequest.FromString,
                    response_serializer=market__pb2.GetSymbolsResponse.SerializeToString,
            ),
    }
...
class MarketService(object):
    ...
    def GetExchanges(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/blueOceanField.market.MarketService/GetExchanges',
            market__pb2.GetExchangesRequest.SerializeToString,
            market__pb2.GetExchangesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetSymbols(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/blueOceanField.market.MarketService/GetSymbols',
            market__pb2.GetSymbolsRequest.SerializeToString,
            market__pb2.GetSymbolsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
